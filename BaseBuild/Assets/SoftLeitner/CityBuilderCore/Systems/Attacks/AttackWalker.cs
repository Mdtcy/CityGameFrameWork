...
namespace CityBuilderCore
{
    ...
    public class AttackWalker : Walker, IAttacker, IHealther
    {
        ...
        protected override void Start()
        {
            ...
            Dependencies.Get<IAttackManager>().AddHealther(this);
        }
        private void OnDestroy()
        {
            Dependencies.Get<IAttackManager>().RemoveAttacker(this);
            Dependencies.Get<IAttackManager>().RemoveHealther(this);
        }
        ...
        public void Recalculate()
        {
            ...
            CurrentWalking.Path = attackerPath.Path;
            CurrentWalking.Index = 0;
