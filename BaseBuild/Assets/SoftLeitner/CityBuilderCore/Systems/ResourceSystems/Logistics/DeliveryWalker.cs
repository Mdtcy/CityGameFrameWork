...
namespace CityBuilderCore
{
    ...
    public class DeliveryWalker : Walker
    {
        ...
        {
            _start = _current;
            _receiver.Instance.Receive(Storage);
        ...
        private void tryDeliver(Vector2Int? position = null)
        {
            ...
            tryWalk(() =>
             {
                 var receiverPath = Dependencies.Get<IReceiverPathfinder>().GetReceiverPath(_home.Instance, position, Storage.GetItems().FirstOrDefault(), MaxDistance, PathType, PathTag);
        ...
        private void tryReturn()
        {
            ...
            tryWalk(_home.Instance, planned: () => _state = DeliveryWalkerState.Returning, finished: onFinished);
        }
        ...
        public override string GetDescription()
        {
            ...
            parameters.Add(_home.Instance.GetName());
