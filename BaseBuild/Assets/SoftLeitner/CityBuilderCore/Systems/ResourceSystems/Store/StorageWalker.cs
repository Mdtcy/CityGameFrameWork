...
namespace CityBuilderCore
{
    ...
    /// </summary>
    public class StorageWalker : Walker
    {
        ...
        public void StartSupply(BuildingComponentPath<IItemReceiver> receiverPath, ItemStorage storage, Item item)
        {
            ...
            storage.MoveItemsTo(Storage, item, receiverPath.Component.Instance.GetItemCapacityRemaining(item));
        ...
        private void returnHome()
        {
            ...
            tryWalk(() => PathHelper.FindPath(_current, _home.Instance, PathType, PathTag), planned: () => _state = StorageWalkerState.Returning);
        }
