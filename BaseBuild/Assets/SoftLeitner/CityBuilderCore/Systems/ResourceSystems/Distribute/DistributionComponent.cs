...
{
    /// <summary>
    /// building component that uses walkers to check what items recipients need, get them from givers and then distributes them to <see cref="IItemRecipient"/>
    /// </summary>
    public class DistributionComponent : BuildingComponent, IDistributionComponent
    {
        ...
        public IEnumerable<Item> GetItems() => Storage.GetItem().Union(_wishlist);
