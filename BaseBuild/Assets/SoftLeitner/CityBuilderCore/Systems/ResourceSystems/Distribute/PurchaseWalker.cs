...
{
    /// <summary>
    /// walker that gets items from an <see cref="IItemGiver"/>
    /// </summary>
    public class PurchaseWalker : Walker
    {
        ...
        private void returnHome()
        {
            ...
            tryWalk(() => Dependencies.Get<IRoadPathfinder>().FindPath(_current, _start, PathTag), planned: () => _state = PurchaseWalkerState.Returning);
        }
