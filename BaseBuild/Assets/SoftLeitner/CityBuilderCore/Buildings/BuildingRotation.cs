...
namespace CityBuilderCore
{
    ...
    public class BuildingRotation
    {
        ...
        public BuildingRotation()
        {

        }
        public BuildingRotation(int state)
        {
            State = state;
        }
        public BuildingRotation(Quaternion rotation)
        {
            float angle;
        ...
        /// <returns></returns>
        public Vector2Int RotateOrigin(Vector2Int origin, Vector2Int size)
        {
        ...
        /// <returns></returns>
        public Vector2Int UnrotateOrigin(Vector2Int point, Vector2Int size)
        {
            size = RotateSize(size);
        ...
        /// <param name="size"></param>
        /// <returns></returns>
        public Vector2Int RotateBuildingPoint(Vector2Int origin, Vector2Int point, Vector2Int size)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Quaternion GetRotation() => GetRotation(Dependencies.Get<IMap>().IsXY);
        public Quaternion GetRotation(bool isXY)
        {
            if (isXY)
                return Quaternion.AngleAxis(State * 90, Vector3.forward);
            else
